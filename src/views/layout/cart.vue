  ...
  <div class="cart">
    ...
    <div class="footer-fixed">
      ...
      <div class="all-total">
        ...
        <div v-if="!isEdit" class="goPay" :class="{disabled: selCount === 0}" @click="goPay">總計({{selCount}})</div>
        <div v-else @click="handleDel" class="delete" :class="{disabled: selCount === 0}">刪除</div>
      </div>
    </div>
    </div>

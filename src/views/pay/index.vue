<template>
  <div class="pay">
    <van-nav-bar fixed title="結帳" left-arrow @click-left="$router.go(-1)" />
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="flow-num-box">
        <span>共 {{ order.orderTotalNum }} 件商品，總計：</span>
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!selectedAddress">請選擇配送地址</span>
      ...
      <div class="pay-way">
        ...
        <div class="pay-cell">
          <span><van-icon name="balance-o" />餘額付款（可用 $ {{ personal.balance }} 元）</span>
          <span class="red"><van-icon name="passed" /></span>
        </div>
      </div>

      <div class="buytips">
        <textarea v-model="remark" placeholder="選填：買家留言（50字内）" name="" id="" cols="30" rows="10"></textarea>
      </div>
    </div>

    <div class="footer-fixed">
      <div class="left">實際付款：<span>${{ order.orderTotalPrice }}</span></div>
